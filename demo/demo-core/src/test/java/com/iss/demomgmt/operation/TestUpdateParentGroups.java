...
public class TestUpdateParentGroups {
    ...
    public void shouldCallTheOperation() throws OperationException {
        ...
        DocumentModel doc = (DocumentModel) automationService.run(ctx, UpdateParentGroups.ID);
    ...
    public void shouldCallWithParameters() throws OperationException {
        ...
        DocumentModel doc = (DocumentModel) automationService.run(ctx, UpdateParentGroups.ID, params);
